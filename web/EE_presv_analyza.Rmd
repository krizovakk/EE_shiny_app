...
# pro test
  ...
  fix_cena <- data.frame(
    ...
    Hodnota = c(
      ...
      paste("testovaci"),
      # ifelse(typ_vypoctu == "indikativni"|conditionCSV|condition4GW|conditionTYP|!conditionPLA, paste("Pouze indikativní"), paste("Závazná")),
      suma_profil,
      # paste(
      ...
      paste("Minimální:", round(predavaciCena_czk+marzeMin*kurz, 2), 
            " /  Doporučená:", round(predavaciCena_czk+marzeDop*kurz, 2))
    )
  )
```
